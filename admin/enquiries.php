...
if (isset($_POST['delete'])) {
    ...
    $query = "DELETE FROM `enquiries` WHERE id='$s_id'";
...
<div>
    <h3 class="text-center" style="padding-top:60px;background: black;color: #fff;font-weight: 600;">Client Enquiry Details</h3>
</div>
