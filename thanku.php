      ...
      <div class="container" style="position:relative;top:3rem;">
        ...
        <div class="row" style="padding:20px;">
          ...
          <div class="col-sm-12">
            ...
            <h3 style="padding:10px 0px;color:green;font-weight:700;text-align:center;font-size:40px;">Your Message Has Been Sent Successfully.</h3>
            <h3 style="padding:15px 0px;color:#fff;font-weight:700;text-align:center;"> I Will Contact You As Soon As Possible. </h3>

          </div>

          <div class="col p-4 my-4" style="display:flex;justify-content:center;">

            <input type="button" id="enroll" class="btn btn-success text-white" value="Back To Homepage" style="margin:4px;padding:10px;font-size:22px;border-radius:30px;font-weight:700;width:250px;" onclick="funpg()">
